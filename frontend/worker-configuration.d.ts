/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv` (hash: 270d84f6bee24eab925ac3d64392553c)
// Runtime types generated with workerd@1.20250424.0 2025-03-07 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		HOSTNAME: "do-collab-backend.not-a-single-bug.workers.dev";
		PROJECT_STATE: DurableObjectNamespace /* ProjectStateObject from lib/durable-objects/ProjectState.ts */;
		ASSETS: Fetcher;
	}
}
